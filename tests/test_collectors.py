...
def test_kalshi():
    ...
    markets = collector.fetch_markets(series_ticker=None, limit=100)
    cs_markets = [m for m in markets if "Counter-Strike" in m.event_name or "CS2" in m.event_name or "CS:GO" in m.event_name]
